...
var text = 'With the universe as a spectator, they timidly stretched out their arms in synchrony'
var t = Timer.new()
var vel_text = 0.035
var listo = false
...
func _process(delta):
	...
	if Input.is_action_just_pressed("saltar") and listo == true:
		...
		get_tree().change_scene_to_file("res://Scenes/Cinemática final/3f.tscn")
