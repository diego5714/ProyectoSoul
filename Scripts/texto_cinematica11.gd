...
var text = 'A mere selfish desire that gave him and the pixelated angel a reason to exist'
var t = Timer.new()
var vel_text = 0.035
var listo = false
...
func _process(delta):
	...
	if Input.is_action_just_pressed("saltar") and listo == true:
		...
		get_tree().change_scene_to_file("res://Scenes/Cinemática final/9f.tscn")
