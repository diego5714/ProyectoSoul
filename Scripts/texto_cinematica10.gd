...
var text = 'The truth is that for him this conflict was nothing more than a passing game'
var t = Timer.new()
var vel_text = 0.035
var listo = false
...
func _process(delta):
	...
	if Input.is_action_just_pressed("saltar") and listo == true:
		...
		get_tree().change_scene_to_file("res://Scenes/Cinemática final/8f.tscn")
